...
class Db {
   ...
   protected $lifeTime      = ''; 
     ...
     * session保存的数据库名
     */
   protected $sessionTable  = 'kyo_session';
...
//        echo ("REPLACE INTO  ".$this->sessionTable." (session_id, session_expire, session_data)  VALUES( '$sessID', '$expire',  '$sessData')");
   ...
   public function gc($sessMaxLifeTime) { 
       ...
       /* kyo Start  2014-10-07 15:21 */
       mysql_query("update users set session_id=null where session_id not in (select session_id from `kyo_session`)");
       /* kyo End 2014-10-07 15:21 */
