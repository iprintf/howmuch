...
class Pdo extends Db{
    ...
    public function query($str,$bind=array()) {
        ...
        /* kyo Start  2014-08-20 17:10 */
        if(false === $this->PDOStatement)
            return $this->error();
        /* kyo End 2014-08-20 17:10 */

        #if 0    //kyo Comment Start 2014-08-20 17:10
        //if(false === $this->PDOStatement)    //抛出异常
        //      E($this->error());        //原代码
        ##endif   //kyo Comment End   2014-08-20 17:10
