    ...
    lang: {
      'en-US': {
        ...
        color: {
          ...
          setTransparent: '清除背景颜色',
          reset: 'Reset',
          // resetToDefault: 'Reset to default'
          resetToDefault: '还原默认颜色'
        },
        shortcut: {
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body = '<h5>' + lang.image.selectFromFiles + '</h5>' +
                   ...
                   '<div class="col-xs-12"><input class="note-image-url form-control span12" type="text" /></div>';
        var footer = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
        return tplDialog('note-image-dialog', lang.image.insert, body, footer);
      };

      var tplLinkDialog = function () {
        var body = '<div class="form-group col-xs-12">' +
